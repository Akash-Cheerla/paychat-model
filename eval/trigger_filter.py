...
_TRIGGERS: dict[str, list[str]] = {
    "money": [
        r"\$\d", r"₹\d", r"€\d",
        r"\bpay\w*\b", r"\bpaid\b", r"\bpy\b", r"\bowe[sd]?\b", r"\bdebt\b", r"\bloan\b",
        r"\bvenmo\b", r"\bvmo\b", r"\bcashapp\b", r"\bcash app\b", r"\bzelle\b",
        ...
        r"\btransfer\b", r"\btrnsfr\b", r"\breimburse\b", r"\bcover me\b", r"\bspot me\b",
        r"\blend me\b", r"\bhalves\b", r"\bhalfsies\b", r"\bdutch\b", r"\bchip in\b",
    ],
    "alarm": [
        r"\bremind\w*\b", r"\brmnd\b", r"\balarm\b", r"\balrm\b", r"\btimer\b",
        r"\bwake me\b", r"\bwke me\b", r"\bping me\b", r"\bnotify me\b",
        r"\bdon'?t forget\b", r"\bdon'?t let me forget\b",
    ],
    "contact": [
        r"\bcall\b", r"\bcal\b", r"\btext\b", r"\btxt\b", r"\bdial\b", r"\bphone\b", r"\bfon\b",
        r"\bwhatsapp\b", r"\bfacetime\b", r"\bmessage\b", r"\bmsg\b",
    ...
    "ride": [
        r"\buber\w*\b", r"\bubr\b", r"\blyft\b", r"\bola\b", r"\bcab\b", r"\btaxi\b",
        r"\bride\b", r"\bbook.{0,10}ride\b", r"\bget.{0,10}cab\b",
        r"\brapido\b", r"\brickshaw\b", r"\bauto\b",
    ],
    "food_order": [
        r"\border\w*\b", r"\bordr\b", r"\bdeliver\w*\b", r"\bdelivr\b",
        r"\bswiggy\b", r"\bzomato\b", r"\bdoordash\b", r"\bubereats\b",
        r"\bgrubhub\b", r"\bpostmates\b",
        r"\bpizza\b", r"\bburger\b", r"\bfood\b", r"\bfud\b",
        r"\bbiryani\b", r"\bnoodles\b", r"\bsushi\b", r"\btacos?\b",
        r"\bmcd\b", r"\bmcdonalds?\b", r"\bkfc\b", r"\bsubway\b",
        r"\bwendy'?s\b", r"\bchick-?fil-?a\b", r"\bcfa\b",
        r"\bchipotle\b", r"\bdominos?\b", r"\bpanda express\b",
        r"\btaco bell\b", r"\bdunkin\b", r"\bstarbucks\b",
    ],
    "travel": [
