...
SINGLE_TESTS = [
    ...
    ("i have a meeting at 2", [], "stating existing meeting"),
    ...
    ("remind me to buy groceries", ["alarm"], "reminder request"),
    ("don't let me forget to call the dentist", ["alarm"], "dont let me forget"),
    ...
    ("where's the nearest starbucks", ["maps"], "finding nearby"),
    ("drop a pin at the restaurant", ["maps"], "drop pin request"),
    ("omw to your place", ["maps"], "on my way"),
    ("i'm lost", [], "being lost but no destination"),
    ...
    ("tell him i said hi", [], "passing along message, no direct call"),
    ...
    ("note to self: be better", [], "self-talk not note intent"),
    ("that's alarming", [], "adjective not alarm"),
    ("i'm booked for the day", [], "busy not booking"),
    ("contact me later", [], "request to be contacted, not calling someone"),
    ...
    ("call mom and tell her dinner is at 7", ["contact", "calendar"], "call + dinner schedule"),
    ...
    ("ong we need food rn", ["food_order"], "gen z food request"),
    ...
    # ── EMOJI-ADJACENT TEXT ──
    ("uber to the party tonight", ["ride", "maps"], "ride to party"),
